...
Tipos de produtores:
 ...
 - Pequeno produtor
	...
	- Uma pessoa consegue operar sozinha
 ...
 - Médio produtor
	...
	- Uma pequena equipe é recomendada
...
- Grande produtor
	...
	- Uma ou mais equipes para cada grupo de galpões é necessária
...
- Fomentar o desenvolvimento do setor por mostrar ao pequeno produtor que é possível expandir a sua produção por meio de automações

- Reduzir a assimetria de informações pela falta de valores fornecidos pela indústria
...
- Mídia digital: [acesse o nosso site](https://romm-0.github.io/Projeto_gpq/)
...
- Consultar as empresas que usaram como base o nosso benchmark para aprimorar os nossos dados

- Permitir o feedback das empresas que usam ou que são apresentadas no nosso projeto

- Permitir sugestões do público na aba de benchmarks 
...
- Quantidade de engajamento do público
...
- Uso de uma aba da comunidade para gerar engajamento entre usuários com um progresso com base no tamanho da comunidade
